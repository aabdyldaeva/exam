...
app.add_url_rule('/position/update', view_func=position_update, methods=['GET', 'POST'], endpoint='position_update')
app.add_url_rule('/position/<int:position_id>/delete', view_func=position_delete, methods=['GET', 'POST'], endpoint='position_delete')


app.add_url_rule('/', view_func=index, methods=['GET', ], endpoint='employees')
